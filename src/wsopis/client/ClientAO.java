...
public class ClientAO extends javax.swing.JFrame {

    public ClientAO(String s) {
        try {
            email = s;
            this.setTitle("Accreditation information");
            initComponents();       
    ...
    private void initComponents() {
        ...
        label1.setText("Accreditation code");

        label2.setText("Surname of journalist");
        ...
        textArea1.setPreferredSize(new java.awt.Dimension(250, 150));
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        try {
            stub.addCode(textField1.getText(), textField2.getText());
            textField1.setText("added");
            textField2.setText("");
            textArea1.setText(stub.printAccreditationList());
       } catch (RemoteException ex) {
            Logger.getLogger(ClientAO.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_button1ActionPerformed

    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        try {
            stub.deleteCode(textField1.getText(), textField2.getText());
